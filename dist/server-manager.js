...
export class LspServerManager {
    ...
    constructor(options = {}) {
        ...
        const env_idle_timeout = process.env.MY_PI_LSP_IDLE_TIMEOUT_MS
            ...
            : undefined;
        const idle_timeout_ms = options.idle_timeout_ms ?? env_idle_timeout;
    ...
    async resolve_file_state(file, ctx) {
    ...
    async #get_or_start_client(file_path, ctx) {
